      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-base sm:text-lg text-gray-600 max-w-2xl mx-auto">
            Trusted by leading organizations committed to environmental conservation and community development
          </p>
        </motion.div>
        ...
        <div className="relative">
          ...
          <motion.div
            ...
            animate={{
              x: [0, -((partners.length * 160) + (partners.length * 32))], // Adjust based on item width and gap
            }}
            transition={{
              x: {
                repeat: Infinity,
          ...
          >
            {duplicatedPartners.map((partner, index) => (
              <motion.div
                ...
                className="flex-shrink-0 w-32 sm:w-40 lg:w-48 h-20 sm:h-24 flex items-center justify-center bg-white rounded-xl sm:rounded-2xl shadow-sm hover:shadow-md transition-all duration-300 border border-gray-100"
                whileHover={{ scale: 1.05, y: -2 }}
              >
                <div className="relative w-24 h-12 sm:w-28 sm:h-16 lg:w-32 lg:h-18">
                  <Image
                    src={partner.logo}
                    alt={partner.name}
                    fill
