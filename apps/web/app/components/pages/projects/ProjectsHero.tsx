        ...
        <div className="relative mx-auto max-w-7xl px-6 py-14 lg:px-8">
          <div className="grid gap-8 lg:grid-cols-[1.4fr_0.8fr] items-center">
            <div className="max-w-2xl text-white">
              <p className="text-sm uppercase tracking-[0.32em] text-[#bfe8c9]">Our Projects</p>
              <h1 className="mt-4 text-3xl font-semibold tracking-tight sm:text-4xl">
                Explore how we deliver impact through forest restoration, climate resilience, children&apos;s advocacy, and sustainable livelihoods.
              </h1>
