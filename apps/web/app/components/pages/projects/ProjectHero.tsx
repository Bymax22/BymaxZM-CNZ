...
export function ProjectHero({ project }: { project: Project }) {
  return (
    <section className="relative min-h-[70vh] flex items-center justify-center bg-gradient-to-br from-[#029346] via-[#0C4726] to-[#08331C]">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
        ...
        >
          <motion.div
            ...
            className="w-24 h-24 mx-auto mb-6 bg-white/10 backdrop-blur-sm rounded-3xl flex items-center justify-center border border-white/20 text-4xl"
          >
            {project.icon}
          </motion.div>
          ...
          <p className="text-2xl text-[#F79021] font-semibold mb-6">
            {project.subtitle}
          </p>
