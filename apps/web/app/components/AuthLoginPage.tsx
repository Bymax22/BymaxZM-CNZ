...
interface AuthLoginPageProps {
  selectedRole?: RoleKey | string;
}

export default function AuthLoginPage({ selectedRole: selectedRoleProp }: AuthLoginPageProps) {
  ...
  const selectedRole = selectedRoleProp ?? searchParams.get('role') ?? undefined;
