    ...
    <main className="bg-white text-gray-900">
      <section className="py-20 border-b border-gray-200">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-sm font-semibold uppercase tracking-[0.4em] text-gray-500 mb-3">Our Initiatives</p>
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">Driving change through targeted action and advocacy</h1>
